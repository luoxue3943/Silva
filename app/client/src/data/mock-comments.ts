 ...
 */
export type Comment = {
  id: number; // 评论主键（唯一标识） / Comment primary key (unique identifier)
  post_id: number; // 所属帖子/文章 ID（外键 posts.id） / Post/article ID (foreign key posts.id)
  parent_id: number | null; // 父评论 ID（自引用 comments.id） / Parent comment ID (self-reference comments.id)
  author: string; // 作者显示名（快照字段） / Author display name (snapshot field)
  floor: number; // 楼层号（如 1、1.2） / Floor number (e.g., 1, 1.2)
...
export const MOCK_COMMENTS: Comment[] = [
  // 顶级评论 1 / Top-level comment 1
  {
    ...
    location: "北京市海淀区",
    created_at: 1734329425000, // 2025-12-16T14:30:25+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 评论 1 的回复 1.1 / Reply 1.1 to comment 1
  {
    ...
    location: "中国",
    created_at: 1734333910000, // 2025-12-16T15:45:10+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 评论 1 的回复 1.2 / Reply 1.2 to comment 1
  {
    ...
    location: "北京市海淀区",
    created_at: 1734335133000, // 2025-12-16T16:05:33+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 2 / Top-level comment 2
  {
    ...
    location: "上海市浦东新区",
    created_at: 1734317415000, // 2025-12-16T11:20:15+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 3 / Top-level comment 3
  {
    ...
    location: "中国",
    created_at: 1734245442000, // 2025-12-15T16:30:42+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 评论 3 的回复 3.1 / Reply 3.1 to comment 3
  {
    ...
    location: "中国",
    created_at: 1734248120000, // 2025-12-15T17:15:20+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 4 / Top-level comment 4
  {
    ...
    location: "广东省深圳市",
    created_at: 1734141918000, // 2025-12-14T09:45:18+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 5 / Top-level comment 5
  {
    ...
    location: "中国",
    created_at: 1734091855000, // 2025-12-13T20:10:55+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 评论 5 的回复 5.1 / Reply 5.1 to comment 5
  {
    ...
    location: "中国",
    created_at: 1734096640000, // 2025-12-13T21:30:40+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 6 / Top-level comment 6
  {
    ...
    location: "浙江省杭州市",
    created_at: 1733984730000, // 2025-12-12T14:25:30+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 7 / Top-level comment 7
  {
    ...
    location: "中国",
    created_at: 1733883322000, // 2025-12-11T10:15:22+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 评论 7 的回复 7.1 / Reply 7.1 to comment 7
  {
    ...
    location: "中国",
    created_at: 1733887245000, // 2025-12-11T11:20:45+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 8 / Top-level comment 8
  {
    ...
    location: "四川省成都市",
    created_at: 1733731212000, // 2025-12-09T16:40:12+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 9 / Top-level comment 9
  {
    ...
    location: "中国",
    created_at: 1733720750000, // 2025-12-09T13:25:50+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 评论 9 的回复 9.1 / Reply 9.1 to comment 9
  {
    ...
    location: "中国",
    created_at: 1733723435000, // 2025-12-09T14:10:35+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 10 / Top-level comment 10
  {
    ...
    location: "中国",
    created_at: 1733137825000, // 2025-12-02T18:30:25+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 11 / Top-level comment 11
  {
    ...
    location: "江苏省南京市",
    created_at: 1733126440000, // 2025-12-02T15:20:40+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 顶级评论 12 / Top-level comment 12
  {
    ...
    location: "中国",
    created_at: 1732496130000, // 2025-11-25T09:15:30+08:00
    updated_at: null,
    deleted_at: null,
  },
  // 评论 12 的回复 12.1 / Reply 12.1 to comment 12
  {
    ...
    location: "中国",
    created_at: 1732500615000, // 2025-11-25T10:30:15+08:00
    updated_at: null,
    deleted_at: null,
  },
];
