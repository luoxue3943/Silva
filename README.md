...
This project includes or uses third-party components under their respective licenses:

- **Font**: [ChillRound](https://github.com/Warren2060/ChillRound) - OFL-1.1-RFN
- **Icons**:
